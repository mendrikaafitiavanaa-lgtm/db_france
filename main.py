...
ETAPES_DISPONIBLES = {
    ...
    # "domaine": ("src.DomaineActivite.sirene", "sirene"),
    # "client_cible": ("src.ClientCible.groq_enrichissement", "client_cible"),
    # "fusion": ("src.FusionFinale.fusion", "fusion"),
}
...
def main():
    if len(sys.argv) == 1:
        nom_etape_cli = "migration"
    elif len(sys.argv) == 2 and sys.argv[1] in ETAPES_DISPONIBLES:
